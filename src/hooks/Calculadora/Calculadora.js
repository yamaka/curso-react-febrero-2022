...
const calcular = () =>{
    switch(operacion){
        case '+' : setDisplay((parseInt(operandoA) + parseInt(operandoB)).toString())
    }
}
  ...
  return (
    <div className='container'>
        ...
        <div className='calculadora-container'>
            ...
            <br />
            <hr />
            <div style={{diplay:'flex', flex: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
                <div style={{diplay:'flex', flex: 1, flexDirection: 'row'}} >
                    <div style={{display:'flex', flexDirection:'row', width:'480px'}}>
                    ...
                    <div><BotonNumerico value='0' onPress={onPressNumerico}/><BotonIgual onPress={calcular}/></div>
                </div>
                </div>
                        <div style={{diplay: 'flex', flexDirection:'column', width: '30%'}}>
